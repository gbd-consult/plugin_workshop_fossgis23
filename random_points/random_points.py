...
class RandomPoints:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Random Points')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/random_points/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'generate random Points for fun'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = RandomPointsDialog(iface=self.iface)
